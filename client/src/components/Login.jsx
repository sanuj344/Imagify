        ...
        <div className='fixed top-0 left-0 right-0 bottom-0 z-10 backdrop-blur-sm bg-black/30 flex justify-center items-center'>
            <motion.form onSubmit={onSubmitHandler}
                ...
                <div className='border px-6 py-2 flex items-center gap-2 rounded-full mt-4 '>
                    ...
                    <input type="email" className='outline-none text-sm ' onChange={e => { setEmail(e.target.value) }} value={email} placeholder='Email id' required />
                </div>
                <div className='border px-6 py-2 flex items-center gap-2 rounded-full mt-4 '>
                ...
                {state === 'Login' ? <p>Don't have an account? <span className='text-blue-600 cursor-pointer' onClick={() => { setState("Sign Up") }}>Sign up</span></p> :
                    <p>Already have an account have an account? <span className='text-blue-600 cursor-pointer' onClick={() => { setState("Login") }}>Login</span></p>}
